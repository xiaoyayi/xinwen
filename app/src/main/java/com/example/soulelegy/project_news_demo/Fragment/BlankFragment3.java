...
public class BlankFragment3 extends Fragment implements XListView.IXListViewListener{

    private String utl = "http://v.juhe.cn/toutiao/index?type=shanghai&key=d4c18a18c3391f90dc971633f6e6f445";
        ...
        protected void onPostExecute(String s) {
            ...
            xListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    String url = datas.get(i-2).getUrl();
